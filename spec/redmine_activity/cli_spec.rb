describe RedmineActivity::CLI do
  ...
  describe '#get' do
    ...
    context 'given --project option' do
      let(:options) { { 'project' => 'test-project' } }
      let(:thor_args) { %w(get --project=test-project) }
  ...
  describe '#today' do
    ...
    context 'given --project option' do
      let(:options) { { 'project' => 'test-project' } }
      let(:thor_args) { %w(today --project=test-project) }
...
Usage: "#{command} today"
  ...
  describe '#yesterday' do
    ...
    context 'given --project option' do
      let(:options) { { 'date' => date, 'project' => 'test-project' } }
      let(:thor_args) { %w(yesterday --project=test-project) }
